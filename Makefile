...
add-to-github:
	@gh repo create battery-hawk --public --source=.
	@git branch -M main
	@git remote add origin https://github.com/UpDryTwist/battery-hawk.git
...
# Multi-arch build for BLE support (arm/v6, arm/v7, arm64, amd64)
docker-build-ble:
ifeq ($(BUILD_DOCKER),true)
