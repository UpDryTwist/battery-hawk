...
class MQTTTopics:
    ...
    # Topic Analysis
    def parse_topic(self, topic: str) -> Optional[Dict[str, Any]]:
        """
        ...
        elif len(parts) >= 3 and parts[0] == "vehicle":
            vehicle_id = parts[1]
            topic_type = parts[2]
            return {
                "category": "vehicle",
        ...
        elif len(parts) >= 2 and parts[0] == "discovery":
            topic_type = parts[1]
            return {
                "category": "discovery",
                "topic_type": topic_type,
    ...
    def get_topic_info(self, topic_type: str) -> Optional[TopicInfo]:
